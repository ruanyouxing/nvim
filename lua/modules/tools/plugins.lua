...
plugin ({'anuvyklack/fold-preview.nvim',
  after = 'nvim-ufo',
  config = conf.fold_preview,
})
plugin ({'lukas-reineke/headlines.nvim',
  ft = { 'markdown', 'org', 'norg' },
  config = conf.headlines,
})
plugin ({'Jxstxs/keystack.nvim',
  config = conf.keystack,
})
...
plugin ({'ziontee113/color-picker.nvim',
  opt = true,
  event = 'InsertEnter',
